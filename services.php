...
<section id="services" class="py-20 bg-gray-50 pt-32">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <?php foreach ($services as $service): ?>
                <div class="bg-white p-6 rounded-lg shadow-md cursor-pointer hover:scale-105 transition-all duration-300">
